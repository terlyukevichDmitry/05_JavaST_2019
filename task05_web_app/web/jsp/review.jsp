...
<c:forEach var="elem" items="${review}" varStatus="status">
        ...
        <tr>
            ...
            <td><input type="submit" value="<fmt:message key="removeReviewLabel"/>" class="btn btn-info"></td>
            </form>
            </c:if>
        </div>
</c:forEach>
...
<nav aria-label="Статьи по Bootstrap 4">
    <ul class="pagination justify-content-center">
        <c:if test="${current_page != 1}">
            <li class="page-item"><a class="page-link" href="${reviewURL}?page=${current_page - 1}"><fmt:message key="previousLabel"/></a></li>
        </c:if>
        ...
        <c:if test="${current_page lt num_of_pages}">
            <li class="page-item"><a class="page-link" href="${reviewURL}?page=${current_page + 1}"><fmt:message key="nextLabel"/></a></li>
        </c:if>
    </ul>
</nav>
<br><br><br>
