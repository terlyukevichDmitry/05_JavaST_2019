...
import by.epam.task01.repository.specification.FindByVolumeSpecification;
...
public class FindByVolumeSpecificationTest {
     ...
     * constant.
     */
    private final double checkUpperBorder = 2000;
    /**
     * {@inheritDoc}
     * @return object with data for data_side.
     */
    @DataProvider(name = "data_find_object_by_volume")
    ...
    public void specifiedTest(final double lowerBorder,
        ...
        FindByVolumeSpecification specification =
                new FindByVolumeSpecification(lowerBorder, upperBorder);
