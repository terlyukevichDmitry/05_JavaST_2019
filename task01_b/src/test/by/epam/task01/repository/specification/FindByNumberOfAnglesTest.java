...
public class FindByNumberOfAnglesTest {
     ...
     * constant.
     */
    private final double checkLowerBorder = 4;
    /**
     * constant.
     */
     ...
     */
    @DataProvider(name = "data_find_object_by_number_of_angles")
    ...
    public void specifiedTest(final double lowerBorder,
        ...
        FindByNumberOfAngles specification =
                new FindByNumberOfAngles(lowerBorder, upperBorder);
