...
public class CloneCompositeTest {
    ...
    public void cloningCompositeTest() throws MissingWayFileException,
        ...
        TextComposite actual = new TextComposite(composite);
        SortParagraphBySentence sortParagraphBySentence = new SortParagraphBySentence();
        sortParagraphBySentence.sortingData(actual);
