    ...
    <div class="col-5">
        ...
        <c:if test="${user.role.name eq 'administrator'}">
            ...
            <form action="${updateQuestURL}" method="get">
                ...
                <input type="submit" value="<fmt:message key="updateQuestLabel"/>" class="btn btn-success">
            </form>
            </div>
        </c:if>
    </div>
    <div class="col-7">
        <h4><fmt:message key="placeInformationLabel"/>:</h4>
        <table class="table table-th-block">
            <tbody>
            <tr><td class="active"><fmt:message key="nameQuestPlaceLabel"/>:</td><td><c:out value="${ elem.name }"/></td></tr>
            <tr><td class="active"><fmt:message key="questPlaceAddressLabel"/>:</td><td><c:out value="${ elem.address }"/></td></tr>
            <tr><td class="active"><fmt:message key="questPlacePhoneNumberLabel"/>:</td><td><c:out value="${ elem.phone }"/></td></tr>
            </tbody>
        </table>
        <h4><fmt:message key="questInformationLabel"/>:</h4>
        <table class="table table-th-block">
            <tbody>
            <tr><td class="active"><fmt:message key="questTitleLabel"/>:</td><td><c:out value="${ elem.quest.title }"/></td></tr>
            <tr><td class="active"><fmt:message key="questLevelLabel"/>:</td><td><c:out value="${ elem.quest.level }"/></td></tr>
            <tr><td class="active"><fmt:message key="maxNumberOfPeopleLabel"/>:</td><td><c:out value="${ elem.quest.maxPeople }"/></td></tr>
            </tbody>
        </table>
    </div>
</div>
    <h4><fmt:message key="aboutQuestLabel"/>:</h4>
    <table class="table table-th-block">
        <tbody>
...
<div class="col-sm">
    <c:url value="/addReview" var="addReviewURL"/>
        <form action="${addReviewURL}" method="post">
            ...
            <i class="fas fa-pencil-alt prefix"></i><label for="form22">&nbsp;&nbsp;<fmt:message key="writeReviewLabel"/>:</label>
